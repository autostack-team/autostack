...
class StackOverflowScraper:
    '''
    An iterable that iterates over StackOverflow posts
    for a given query.
    '''
    ...
    def query(self, search_strings):
        '''
        Returns the soup of the Stack Overflow query.
        '''
        ...
        # Build the query.
        url = url + search_strings[0]
        for i in search_strings[1:]:
            url = url + "+" + i
        ...
        # Convert the html to a BeautfulSoup object.
